...
//
// Vendored verbatim from upstream zx2c4/wireguard-apple
// (Sources/Shared/Model/TunnelConfiguration+WgQuickConfig.swift)
// because Mullvad's WireGuardKit fork does not export this parser
// through its public WireGuardKit product — it lives in their
// app-internal "Shared" module. MIT license stays applicable.
